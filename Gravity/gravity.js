...
function debugStringifyPoint(point) {
    const placeholderID = "##DIV-ID##";
    const hackyWidthPx = 100;
    const divDefaultStyle = "display: inline-block;" +
        "position: absolute;" +
        " z-index: 999;" +
    ...
    let div = debugElement.parentElement;
